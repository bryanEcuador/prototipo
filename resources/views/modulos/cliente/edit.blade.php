...
@section('nombre_pagina','Edición de cliente')
@section('css')
@endsection
@section('titulo de la pagina','Edición de cliente')
@section('subtitulo','Formulario de edición cliente')
    ...
    <div class="col-md-12" id="creacionProveedores">
        <form action="{{route('administrador.proveedor.store')}}" method="post" id="administracion">
           ...
           <div class="form-group row">
            ...
            <button type="submit" class="btn btn-info" id="guardar">Actualizar Cliente</button>
