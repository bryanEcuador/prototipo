...
@section('nombre_pagina','Creacion de comercio piso propoganda')
@section('css')
@endsection
@section('titulo de la pagina','Creacion de comercio piso propoganda')
    ...
    <div class="col-md-12" id="creacionProveedores">
        ...
        <div class="tile">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6 ">
                   <input class="form-control" type="text" name="ruc" v-model="piso" maxlength="20">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6 ">
                   <input class="form-control" type="text" name="representante" v-model="propaganda" maxlength="20">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6 ">
                   <input class="form-control" type="file" name="representante_ci" v-model="imagen" maxlength="20">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6 ">
                   <input class="form-control" type="text" name="direccion" v-model="activo" maxlength="20">
                </div>
            </div>
            
                <br>
               <!--<button type="input" class="btn btn-info" name="guardar" id="guardar">Agregar Proveedor</button> --><!-- v-on:click="guardar" -->
            <button type="submit" class="btn btn-info" id="guardar">Agregar Comercio piso propaganda</button>
                ...
                methods : {
                   ...
                   // validaciones
                    ...
                    enviarFormulario : function(){
                        var url = 'comercio/piso/propaganda/store';
                        axios.post(url, {
