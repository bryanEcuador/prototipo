...
@section('nombre_pagina','Comercio piso propaganda')
@section('css')
...
@if ($errors->any())
    ...
    <div class="col-md-12" id="creacionProveedores">
        ...
        <div class="tile">
            ...
            <a style="color:white" href="{{route('propaganda.create')}}"> Agregar propaganda </a>     
           ...
           <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                       <button class="btn btn-primary"><a style="color:white" href="{{route('propaganda.edit')}}"> <i class="fa fa-pencil-square-o 2x-fa" aria-hidden="true"></i>  </a> </button>
                        <button class="btn btn-info" ><a href="{{route('propaganda.show')}}"><i class="fa fa-eye" aria-hidden="true"></i></a></button>
