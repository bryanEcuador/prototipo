...
class ComercioController extends Controller
{
    ...
    {
        return $this->xml->query($request, 'pr_ins_va_comercios',$this->metodo);
    }

    public function update(Request $request)
    {
        return $this->xml->query($request,'pr_upd_va_comercios',$this->metodo);
    }
    ...
    public function search($paginacion = 5, $pagina=0 , $nombre = null){
        ...
        return $this->xml->query($parametros, 'pr_sel_va_comercios',$this->metodo, true,$pagina,$paginacion);
    }
    ...
    { 
        ...
        return $this->xml->query($parametros, 'pr_sel_va_comercios',$this->metodo);
    }
